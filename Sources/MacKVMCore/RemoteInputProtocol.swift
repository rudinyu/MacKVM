...
public enum MediaKey: Int, Codable, CaseIterable, Hashable, Sendable {
    case soundUp = 0
    case soundDown = 1
    case brightnessUp = 2
...
public struct RemoteInputEvent: Codable, Equatable, Sendable {
    ...
    /// Whether a keyDown is an auto-repeat generated by macOS. It is optional
    /// so events from older peers keep decoding and default to the platform's
    /// normal non-repeat state at injection time.
